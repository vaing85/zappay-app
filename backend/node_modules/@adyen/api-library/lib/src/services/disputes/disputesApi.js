...
const objectSerializer_1 = require("../../typings/disputes/objectSerializer");
/**
...
class DisputesApi extends service_1.default {
    ...
    */
    async acceptDispute(acceptDisputeRequest, requestOptions) {
        ...
        const request = objectSerializer_1.ObjectSerializer.serialize(acceptDisputeRequest, "AcceptDisputeRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "AcceptDisputeResponse");
    }
    /**
    ...
    */
    async defendDispute(defendDisputeRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(defendDisputeRequest, "DefendDisputeRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "DefendDisputeResponse");
    }
    /**
    ...
    */
    async deleteDisputeDefenseDocument(deleteDefenseDocumentRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(deleteDefenseDocumentRequest, "DeleteDefenseDocumentRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "DeleteDefenseDocumentResponse");
    }
    /**
    ...
    */
    async retrieveApplicableDefenseReasons(defenseReasonsRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(defenseReasonsRequest, "DefenseReasonsRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "DefenseReasonsResponse");
    }
    /**
    ...
    */
    async supplyDefenseDocument(supplyDefenseDocumentRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(supplyDefenseDocumentRequest, "SupplyDefenseDocumentRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "SupplyDefenseDocumentResponse");
    }
}
