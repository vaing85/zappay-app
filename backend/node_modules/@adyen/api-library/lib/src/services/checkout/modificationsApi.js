...
class ModificationsApi extends service_1.default {
    ...
    */
    async cancelAuthorisedPayment(standalonePaymentCancelRequest, requestOptions) {
        ...
        const request = objectSerializer_1.ObjectSerializer.serialize(standalonePaymentCancelRequest, "StandalonePaymentCancelRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StandalonePaymentCancelResponse");
    }
    /**
    * @summary Cancel an authorised payment
    ...
    */
    async cancelAuthorisedPaymentByPspReference(paymentPspReference, paymentCancelRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(paymentCancelRequest, "PaymentCancelRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "PaymentCancelResponse");
    }
    /**
    ...
    */
    async captureAuthorisedPayment(paymentPspReference, paymentCaptureRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/payments/{paymentPspReference}/captures`
            .replace("{" + "paymentPspReference" + "}", encodeURIComponent(String(paymentPspReference)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(paymentCaptureRequest, "PaymentCaptureRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "PaymentCaptureResponse");
    }
    /**
    ...
    */
    async refundCapturedPayment(paymentPspReference, paymentRefundRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/payments/{paymentPspReference}/refunds`
            .replace("{" + "paymentPspReference" + "}", encodeURIComponent(String(paymentPspReference)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(paymentRefundRequest, "PaymentRefundRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "PaymentRefundResponse");
    }
    /**
    ...
    */
    async refundOrCancelPayment(paymentPspReference, paymentReversalRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/payments/{paymentPspReference}/reversals`
            .replace("{" + "paymentPspReference" + "}", encodeURIComponent(String(paymentPspReference)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(paymentReversalRequest, "PaymentReversalRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "PaymentReversalResponse");
    }
    /**
    ...
    */
    async updateAuthorisedAmount(paymentPspReference, paymentAmountUpdateRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/payments/{paymentPspReference}/amountUpdates`
            .replace("{" + "paymentPspReference" + "}", encodeURIComponent(String(paymentPspReference)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(paymentAmountUpdateRequest, "PaymentAmountUpdateRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "PaymentAmountUpdateResponse");
    }
}
