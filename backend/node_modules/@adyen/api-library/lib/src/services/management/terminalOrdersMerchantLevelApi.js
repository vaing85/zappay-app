...
class TerminalOrdersMerchantLevelApi extends service_1.default {
    ...
    */
    async cancelOrder(merchantId, orderId, requestOptions) {
        ...
        return objectSerializer_1.ObjectSerializer.deserialize(response, "TerminalOrder");
    }
    /**
    ...
    */
    async createOrder(merchantId, terminalOrderRequest, requestOptions) {
        const endpoint = `${this.baseUrl}/merchants/{merchantId}/terminalOrders`
            .replace("{" + "merchantId" + "}", encodeURIComponent(String(merchantId)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(terminalOrderRequest, "TerminalOrderRequest");
    ...
    */
    async createShippingLocation(merchantId, shippingLocation, requestOptions) {
        const endpoint = `${this.baseUrl}/merchants/{merchantId}/shippingLocations`
            .replace("{" + "merchantId" + "}", encodeURIComponent(String(merchantId)));
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(shippingLocation, "ShippingLocation");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "ShippingLocation");
    }
    /**
    ...
    */
    async listBillingEntities(merchantId, name, requestOptions) {
        ...
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "BillingEntitiesResponse");
    }
    /**
    ...
    */
    async listOrders(merchantId, customerOrderReference, status, offset, limit, requestOptions) {
        ...
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "TerminalOrdersResponse");
    }
    /**
    ...
    */
    async listShippingLocations(merchantId, name, offset, limit, requestOptions) {
        ...
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "ShippingLocationsResponse");
    }
    /**
    ...
    */
    async listTerminalModels(merchantId, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "TerminalModelsResponse");
    }
    /**
    ...
    */
    async listTerminalProducts(merchantId, country, terminalModelId, offset, limit, requestOptions) {
        ...
        const response = await (0, getJsonResponse_1.default)(resource, "", { ...requestOptions, method: "GET" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "TerminalProductsResponse");
    }
    /**
