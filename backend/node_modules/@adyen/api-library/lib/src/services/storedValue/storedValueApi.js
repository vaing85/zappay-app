...
const objectSerializer_1 = require("../../typings/storedValue/objectSerializer");
/**
...
class StoredValueApi extends service_1.default {
    ...
    */
    async changeStatus(storedValueStatusChangeRequest, requestOptions) {
        ...
        const request = objectSerializer_1.ObjectSerializer.serialize(storedValueStatusChangeRequest, "StoredValueStatusChangeRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StoredValueStatusChangeResponse");
    }
    /**
    ...
    */
    async checkBalance(storedValueBalanceCheckRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(storedValueBalanceCheckRequest, "StoredValueBalanceCheckRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StoredValueBalanceCheckResponse");
    }
    /**
    ...
    */
    async issue(storedValueIssueRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(storedValueIssueRequest, "StoredValueIssueRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StoredValueIssueResponse");
    }
    /**
    ...
    */
    async load(storedValueLoadRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(storedValueLoadRequest, "StoredValueLoadRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StoredValueLoadResponse");
    }
    /**
    ...
    */
    async mergeBalance(storedValueBalanceMergeRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(storedValueBalanceMergeRequest, "StoredValueBalanceMergeRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StoredValueBalanceMergeResponse");
    }
    /**
    ...
    */
    async voidTransaction(storedValueVoidRequest, requestOptions) {
        ...
        const resource = new resource_1.default(this, endpoint);
        const request = objectSerializer_1.ObjectSerializer.serialize(storedValueVoidRequest, "StoredValueVoidRequest");
        const response = await (0, getJsonResponse_1.default)(resource, request, { ...requestOptions, method: "POST" });
        return objectSerializer_1.ObjectSerializer.deserialize(response, "StoredValueVoidResponse");
    }
}
