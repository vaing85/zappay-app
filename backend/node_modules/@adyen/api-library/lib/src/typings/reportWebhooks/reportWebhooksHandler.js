...
exports.ReportWebhooksHandler = void 0;
const __1 = require("..");
/**
...
class ReportWebhooksHandler {
    ...
    getGenericWebhook() {
        ...
        if (Object.values(__1.reportWebhooks.ReportNotificationRequest.TypeEnum).includes(type)) {
    ...
    getReportNotificationRequest() {
        return __1.reportWebhooks.ObjectSerializer.deserialize(this.payload, "ReportNotificationRequest");
    }
}
exports.ReportWebhooksHandler = ReportWebhooksHandler;
//# sourceMappingURL=reportWebhooksHandler.js.map