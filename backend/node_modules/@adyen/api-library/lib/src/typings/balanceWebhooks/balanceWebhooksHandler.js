...
exports.BalanceWebhooksHandler = void 0;
const __1 = require("..");
/**
...
class BalanceWebhooksHandler {
    ...
    getGenericWebhook() {
        ...
        if (Object.values(__1.balanceWebhooks.BalanceAccountBalanceNotificationRequest.TypeEnum).includes(type)) {
    ...
    getBalanceAccountBalanceNotificationRequest() {
        return __1.balanceWebhooks.ObjectSerializer.deserialize(this.payload, "BalanceAccountBalanceNotificationRequest");
    }
}
exports.BalanceWebhooksHandler = BalanceWebhooksHandler;
//# sourceMappingURL=balanceWebhooksHandler.js.map